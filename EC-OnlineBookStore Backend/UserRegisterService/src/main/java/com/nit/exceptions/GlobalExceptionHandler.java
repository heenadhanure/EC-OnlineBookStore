...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<Object> custmerHandleException(UserIdNotFoundException ex) {
		List<String> details = new ArrayList<>();
		details.add("Error : User Id not found");
		details.add("Detailed Message:" + ex.getLocalizedMessage());
		details.add("Timestamp:" + System.currentTimeMillis());
		ErrorMessage error = new ErrorMessage(HttpURLConnection.HTTP_BAD_REQUEST, Constants.FAILURE, "User Id Not Found",details);
