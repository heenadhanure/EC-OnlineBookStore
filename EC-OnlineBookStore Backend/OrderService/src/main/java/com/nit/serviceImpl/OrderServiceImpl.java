...
public class OrderServiceImpl implements OrderService{
	...
	// Helper method to check whether the user is a Prime user
		...
		@Override
		public Orders getOrderByCustomerId(Long customerId) {
			Optional<Orders> findById = orderRepository.findById(customerId);
			return findById.get();
		}
